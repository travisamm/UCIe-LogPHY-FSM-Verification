...
endclass
// ============================================================
// seq_mbtrain_dc2: focused DC2-01 sequence
// ============================================================
class seq_mbtrain_dc2 extends mbtrain_base_seq;
  `uvm_object_utils(seq_mbtrain_dc2)

  function new(string name = "seq_mbtrain_dc2");
    super.new(name);
  endfunction
...
// ============================================================
// seq_mbtrain_linkspeed: focused LS-01/03 sequence
// ============================================================
class seq_mbtrain_linkspeed extends mbtrain_base_seq;
  `uvm_object_utils(seq_mbtrain_linkspeed)

  function new(string name = "seq_mbtrain_linkspeed");
    super.new(name);
  endfunction
